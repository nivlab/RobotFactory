...
transformed data {
    ...
    array[NJ,NK] int Vk;                    // Stimulus valence
    for (n in 1:N)
        Vk[J[n],K[n]] = V[n];
...
transformed parameters {
    ...
    vector[NJ]  b2;                         // Go bias (positive valence)
    vector[NJ]  b3;                         // Go bias (negative valence)
    ...
    b3 = Phi_approx(theta_mu[3] + theta[,3]);
