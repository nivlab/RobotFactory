...
transformed parameters {
    ...
    a1 = Phi_approx((theta_mu[4] + theta[,4]) + (theta_mu[5] + theta[,5]));
    a2 = Phi_approx((theta_mu[4] + theta[,4]) - (theta_mu[5] + theta[,5]));
    a3 = Phi_approx(theta_mu[4] + theta[,4]);
...
model {
    ...
    for (n in 1:N) {
        ...
        real eta = (V[n] == 1 && R[n] == 1) ? a1[J[n]] : (V[n] == 0 && R[n] == 0) ? a2[J[n]] : a3[J[n]];
