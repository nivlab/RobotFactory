...
parameters {
    ...
    matrix[7,2]   theta_mu;                 // Population-level effects
...
model {
    ...
    for (n in 1:N) {
        ...
        mu[n] = (0.5 * xi) + (1-xi) * inv_logit(beta * (Q[J[n],K[n],M[n],2] - Q[J[n],K[n],M[n],1]) + tau);
...
generated quantities {
    ...
    row_vector[2]  c1_mu = Phi_approx(-2.0 + theta_mu[7]);
